@extends('layouts.app')
@section('title', 'Edit LoanCartegory')
@section('name', 'Edit LoanCartegory')
@section('content')
<div class="max-w-full mx-auto bg-white px-4 py-6 shadow-lg rounded-lg">
    <h2 class="text-2xl font-semibold text-gray-700 mb-6">Edit Loan Category</h2>
    <form action="{{ route('loan-categories.update', $loanCart->id) }}" method="POST" class="space-y-6">
        @csrf
        @method('PATCH')
        <!-- Loan Name -->
        <div>
            ...
            <div class="relative">
                ...
                <input type="text" name="loanName" id="loanName" value="{{ old('loanName', $loanCart->loanName) }}" required 
        ...
        <div class="flex gap-4">
            ...
            <div class="flex-1">
                ...
                <div class="relative">
                    ...
                    <input type="number" name="minAmount" id="minAmount" value="{{ old('minAmount',$loanCart->minAmount) }}" required step="0.01" 
                        class="w-full border border-gray-300 rounded-lg pl-10 py-2 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500" 
            ...
            <div class="flex-1">
                ...
                <div class="relative">
                    <i class="fa-solid fa-dollar-sign absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400"></i>
                    <input type="number" name="maxAmount" id="maxAmount" value="{{ old('maxAmount', $loanCart->maxAmount) }}" required step="0.01" 
                        class="w-full border border-gray-300 rounded-lg pl-10 py-2 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500" 
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input type="number" name="interest" id="interest" value="{{ old('interest', $loanCart->interest) }}" required 
                    class="w-full border border-gray-300 rounded-lg pl-10 py-2 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500" 
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input type="number" name="dueDatedays" id="dueDatedays" value="{{ old('dueDatedays', $loanCart->dueDatedays) }}" required 
                    class="w-full border border-gray-300 rounded-lg pl-10 py-2 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500" 
